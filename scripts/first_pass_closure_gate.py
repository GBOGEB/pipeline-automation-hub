...
def validate_run(client: Any, spec: dict[str, Any], receipt_head: str, policy: dict[str, Any]) -> dict[str, Any]:
...
def evaluate(client: Any, repo: str, pr_number: int, policy: dict[str, Any]) -> dict[str, Any]:
...
def main() -> int:
    ...
    try:
        policy = json.loads(open(args.policy, "r", encoding="utf-8").read())
