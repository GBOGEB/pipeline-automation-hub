...
def main():
    ...
    f=d["fleet"]
    assert (total,control,active,blocked)==(94,31,1,62)
    assert (f["open_issues"],f["control"],f["active"],f["blocked"])==(94,31,1,62)
    ...
    print("PASS_FLEET_OPEN_ISSUE_CONVERGENCE_94_31_1_62")
